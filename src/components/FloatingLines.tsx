...
// 源码来源：reactbits.dev · Backgrounds/FloatingLines
// https://github.com/DavidHDev/react-bits/blob/main/src/content/Backgrounds/FloatingLines/FloatingLines.jsx
// 许可证：MIT + Commons Clause（项目内使用允许，禁止转卖组件本身）
// 改动：JS → TypeScript 类型注解；逻辑保持官方原样
...
export default function FloatingLines({
  ...
  const getLineDistance = (waveType: WaveName): number => {
